...
# Application
An application built from https://github.com/redhat-appstudio-mjf/chatbot2-may1-2 will be stored in [quay.io/maysunfaisal/chatbot2-may1-2](https://quay.io/maysunfaisal/chatbot2-may1-2) and deployed through GitOps. This application is accessible on port **8501**.